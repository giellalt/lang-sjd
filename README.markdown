...
This directory contains source files for the Kildin Sami language
...
-   <https://giellalt.uit.no/lang/sjd/index.html> (analyser)
...
The Kildin Sami language sources can be acquired using [giella SVN
