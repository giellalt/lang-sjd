%Open source documents describing (parts of) Kildin Sami grammar
%Be aware that this is work-in-progress, which is very likely to contain errors and incomplete data.
%Copyright © 2012 Giellatekno & The authors, http://giellatekno.uit.no 
...
Institut for Psycholinguistics, \url{http://www.mpi.nl/DOBES/}).% and from elicitations and experiments with native speakers. KK: das schaffen wir eh nicht.
...
\hline
\hline
KSa 		& Gloss			&						& English translation\\	%&NSa translation
\hline
šte		&{\sc COMP} ?		&< Russian {\it što}			&'that'\\				%&ahte	
%bydte	&				&				&ahte\\
jesli		&{\sc	 COMP} ?		&< Russian {\it jesli}			&'if'\\					%&jos
%poke	&				&< Russian {\it poka}		&go\\
gū		&{\sc advCOMP} ??	&$\leftarrow$Proto Saamic	& 'XXX'\\				%&go
\hline
\hline
\end{tabular}
\label{KildinComps}
...
\hline
\hline
SSa 		& Gloss			&						& English translation\\	%&NSa translation
\hline
što		&{\sc COMP} ?		&< Russian {\it što}			&'that'\\				%&ahte	
että		& {\sc COMP}		&<Finnish {\it että}			& 'that'\\
ku		&{\sc	 advCOMP} ?	&$\leftarrow$Proto Saamic	&'if'\\					%&jos
...
%%%%%%%%%% KK->MR : are there differences in use of Sto vs että in Russia and in Finnland?
...
%%%%%%%%%%%%%%%%%%%% KK SSa Sto = markiert reine unterordnung
