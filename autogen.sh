...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_sjd to login script."
...
# the current dir:
if   test x${GTLANG_sjd} = x ; then
	echo "WARNING: The variable \${GTLANG_sjd} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_sjd} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_sjd} has the value:"
	echo "  ${GTLANG_sjd}"
