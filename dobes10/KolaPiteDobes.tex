...
% Do we want to use the Schlachter corpus? I should think so; it is already available in digital form
%Size of the corpus: 109,572 words, 561,654 characters (including tags). Character encoding: ISO 8859-1 (Latin-1)
% http://www.ling.helsinki.fi/uhlcs/readme-all/README-uralic-lgs.html#C32
