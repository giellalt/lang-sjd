...
To allow for multi-layered, consistent annotation of linguistic data, the use of off-the-shelf annotation tools (e.g., NITE XML, MMAX, UAM CorpusTool, MATE Annotation Workbench, etc.) %JW: are any of these tools open-source or not proprietary - best for archiving if open-source, this could/should also be mentioned here if applicable
