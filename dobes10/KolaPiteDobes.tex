...
\subsection{Urgency of documentation}\label{urgency}%the Kola Saami part (MR) ist still missing
...
Within the course of the Kola Saami Documentation Project, recordings of both Kildin and Ter Saami were produced, transcribed and partially annotated for archiving at DoBeS, and are thus available through the DoBeS archive. %JW: andere Kildin/Ter Materialien???
...
At the same time, we will continue to wrok on Kildin Saami and begin testing syntactic parsing operations (disabiguators).%JW: is this the english term?
